  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-2 sm:gap-5 sm:grid-cols-2">
        ...
        <div className="inline-flex items-center sm:mt-1">
          <label
        ...
        <div className="flex flex-row justify-center mb-2 sm:mt-10">
          <button 
            type="submit"
            disabled={!isValid}
            className={clsx('btn-primary flex w-full sm:w-1/2 justify-center',{
              'btn-primary-disable opacity-50 cursor-not-allowed': !isValid
            })}>
            Siguiente
          </button>
        </div>
